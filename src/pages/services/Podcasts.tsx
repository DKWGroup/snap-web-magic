...
const Podcasts = () => {
  ...
  const portfolioItems = [
    {
      id: 1,
      title: 'Podcast Eksperta Finansowego',
      client: 'Investment Partners',
      description: 'Seria podcastów edukacyjnych o tematyce finansowej, które pomogły zwiększyć autorytet klienta w branży.',
      image: '/images/project-2.jpg',
      caseStudyId: '2'
    },
    {
      id: 2,
      title: 'Rozmowy o Lotnictwie',
      client: 'Kokpit Kamila',
      description: 'Podcast z wywiadami z pilotami i ekspertami lotniczymi, regularnie w TOP10 polskich podcastów w kategorii edukacja.',
    ...
    },
    {
      ...
      description: 'Cotygodniowe dyskusje o nowościach technologicznych, trendach i przyszłości IT.',
